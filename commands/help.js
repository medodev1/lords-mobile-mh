  ...
  message.channel.send('ملاحظة : اذا كان اسم الوحش المراد صيده يتكون من مقطعين جرب استخادم المقطع الاول')
    ...
    if(!helpArgs[0]) {
        var embed = new Discord.MessageEmbed() 
            ...
            .setDescription('```ساحرة الشر | جناح الثلج | العملاق الاعور | حاصد الارواح | العنقاء | هاردروكس | عنكبوت الجحيم | البومة | تنين اليشم | حصان طرواده | الدوده العملاقه | نوسيروس | ملكه النحل | سابرفنغ | وحش الثلج | شوكة الرعب | العملاق تيدال | الكاهن فودو ```')
